...
MERGE "uc_connectionpackages" AS TARGET USING (values(-15,'Usercube.SQL@0000001','True','False','False','36','0','0','','USERCUBE','Database/Generic SQL','Exports data from a SQL database.','False','')) AS SOURCE("id","identifier","implementsentitytypemapping","implementsresourcetypemapping","implementsconfiguration","exporttype","fulfillmenttype","inducedfulfillment","keywords","publisher","displayName_l1","description_l1","hasincrementalmode","logourl") ON TARGET."id" = SOURCE."id" WHEN MATCHED THEN UPDATE SET "identifier"=SOURCE."identifier","implementsentitytypemapping"=SOURCE."implementsentitytypemapping","implementsresourcetypemapping"=SOURCE."implementsresourcetypemapping","implementsconfiguration"=SOURCE."implementsconfiguration","exporttype"=SOURCE."exporttype","fulfillmenttype"=SOURCE."fulfillmenttype","inducedfulfillment"=SOURCE."inducedfulfillment","keywords"=SOURCE."keywords","publisher"=SOURCE."publisher","displayName_l1"=SOURCE."displayName_l1","description_l1"=SOURCE."description_l1","hasincrementalmode"=SOURCE."hasincrementalmode","logourl"=SOURCE."logourl" WHEN NOT MATCHED THEN INSERT("id","identifier","implementsentitytypemapping","implementsresourcetypemapping","implementsconfiguration","exporttype","fulfillmenttype","inducedfulfillment","keywords","publisher","displayName_l1","description_l1","hasincrementalmode","logourl") VALUES(SOURCE."id", SOURCE."identifier",SOURCE."implementsentitytypemapping",SOURCE."implementsresourcetypemapping",SOURCE."implementsconfiguration",SOURCE."exporttype",SOURCE."fulfillmenttype",SOURCE."inducedfulfillment",SOURCE."keywords",SOURCE."publisher",SOURCE."displayName_l1",SOURCE."description_l1",SOURCE."hasincrementalmode",SOURCE."logourl");
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371920890658775, 2147483675,'PolicySimulations',12,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371877940985856, 2147483685,'Id',3,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371843581247426, 2147483693,'FullName_L11',0,-1,-9223371843581247452,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371796336607228, 2147483704,'Tostate',12,-1,NULL,2147483703)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371766271836117, 2147483711,'P33',0,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371740502032327, 2147483717,'AutocompleteBindingId',3,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371366839877623, 2147483804,'BindingId',3,-1,NULL,NULL)
...
,(-9223371345365040994, 2147483809,'Dimension29Id',3,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371345365040991, 2147483809,'Dimension30',12,-1,NULL,2147483670)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371336775106553, 2147483811,'Agent',12,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223371169271381995, 2147483850,'C1',2,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223370890098507753, 2147483915,'ResourcesExpression',0,-1,NULL,NULL)
...
,(-9223370885803540244, 2147483916,'Dimension86Id',3,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223370885803540241, 2147483916,'Dimension87',12,-1,NULL,2147483670)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223370855738769405, 2147483923,'ResourceTypeId',3,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223370817084063229, 2147483932,'WhenChanged',4,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityproperties"("id","entitytype_id","identifier","type","targetcolumnindex","neutralproperty_id","targetentitytype") VALUES (-9223366547886571004, 2147484926,'ChangedById',3,-1,NULL,NULL)
...
;
INSERT INTO "#tmp_um_entityassociations"("id","property1_id","property2_id","identifier","isproperty1collection","isproperty2collection") VALUES (-9223371869351051262, -9223371869351051262,-9223371920890658806,'DisplayTable.EntityType',0,1)
...
;
INSERT INTO "#tmp_um_entityassociations"("id","property1_id","property2_id","identifier","isproperty1collection","isproperty2collection") VALUES (-9223370890098507262, -9223370890098507262,-9223371942365495034,'ContextRule.CreatedBy',0,1)
