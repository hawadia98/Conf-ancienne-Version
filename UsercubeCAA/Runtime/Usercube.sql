...
Product Version
*/
MERGE "UM_Settings" AS TARGET USING (values(-1,'ProductVersion','6.1.001','','')) AS SOURCE("Id","Identifier","C0","C1","C2") ON TARGET."Id" = SOURCE."Id" WHEN MATCHED THEN UPDATE SET "Identifier"=SOURCE."Identifier","C0"=SOURCE."C0","C1"=SOURCE."C1","C2"=SOURCE."C2" WHEN NOT MATCHED THEN INSERT("Id","Identifier","C0","C1","C2") VALUES(SOURCE."Id", SOURCE."Identifier",SOURCE."C0",SOURCE."C1",SOURCE."C2");
GO
