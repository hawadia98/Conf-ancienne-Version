...
$Uri = "WR034EXG01001V.ca-pacificadev.fr:5985"
$userName = "ca-pacificadev\CS_DEV_EXG"
$password = ConvertTo-SecureString -string "xxxx" -asPlainText -force
...
try {
    $Session = New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri "http://$Uri/PowerShell/" -Authentication Basic -Credential $Credential
